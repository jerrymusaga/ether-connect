        ...
        {!showOnboarding ? (
          ...
          <div className="flex flex-col items-center justify-center min-h-[60vh] p-6 animate-fade-in relative">
            ...
            <div className="absolute inset-0 overflow-hidden pointer-events-none">
              ...
              <div className="absolute -bottom-20 -right-20 w-60 h-60 bg-pink-300/20 rounded-full blur-xl animate-pulse delay-1000"></div>
              <div className="absolute top-1/2 left-1/4 w-32 h-32 bg-blue-300/20 rounded-full blur-xl animate-pulse delay-500"></div>
            </div>

            {/* Animated sparkles */}
            <div className="absolute inset-0 pointer-events-none">
              <div className="absolute top-16 left-16 w-2 h-2 bg-[#C41E3A] rounded-full animate-bounce delay-300"></div>
              <div className="absolute top-32 right-24 w-1 h-1 bg-purple-600 rounded-full animate-bounce delay-700"></div>
              <div className="absolute bottom-32 left-32 w-1.5 h-1.5 bg-pink-500 rounded-full animate-bounce delay-1000"></div>
              <div className="absolute bottom-16 right-16 w-1 h-1 bg-purple-500 rounded-full animate-bounce delay-500"></div>
            </div>

            {/* Main content */}
            <div className="relative z-10 flex flex-col items-center">
              <h1 className="text-4xl sm:text-5xl font-extrabold mb-6 text-[#C41E3A] drop-shadow-2xl text-center animate-bounce">
              ...
              <div className="flex flex-col sm:flex-row gap-6 sm:gap-8 mt-4">
                ...
                <div className="group cursor-pointer transform transition-all duration-300 hover:scale-105 hover:-translate-y-2" onClick={() => setMode('dating')}>
                  <div className="relative bg-gradient-to-br from-blue-100/60 to-purple-100/60 backdrop-blur-sm border-2 border-blue-300/50 rounded-2xl p-6 shadow-2xl hover:shadow-blue-400/40 transition-all duration-300">
                    <div className="absolute inset-0 bg-gradient-to-br from-blue-200/20 to-purple-200/20 rounded-2xl opacity-0 group-hover:opacity-100 transition-opacity duration-300"></div>
                    <div className="relative z-10 text-center">
                      <div className="text-4xl mb-3 animate-bounce">💕</div>
                      <h3 className="text-xl font-bold text-blue-700 mb-2">Dating Mode</h3>
                      <p className="text-gray-600 text-sm">Find your perfect match</p>
                    </div>
                    <div className="absolute -top-1 -right-1 w-6 h-6 bg-blue-300/40 rounded-full animate-ping"></div>
                  </div>
                </div>
                ...
                <div className="group cursor-pointer transform transition-all duration-300 hover:scale-105 hover:-translate-y-2" onClick={() => setMode('friendship')}>
                  <div className="relative bg-gradient-to-br from-green-100/60 to-emerald-100/60 backdrop-blur-sm border-2 border-green-300/50 rounded-2xl p-6 shadow-2xl hover:shadow-green-400/40 transition-all duration-300">
                    <div className="absolute inset-0 bg-gradient-to-br from-green-200/20 to-emerald-200/20 rounded-2xl opacity-0 group-hover:opacity-100 transition-opacity duration-300"></div>
                    <div className="relative z-10 text-center">
                      <div className="text-4xl mb-3 animate-bounce delay-200">🤝</div>
                      <h3 className="text-xl font-bold text-green-700 mb-2">Friendship Mode</h3>
                      <p className="text-gray-600 text-sm">Build lasting friendships</p>
                    </div>
                    <div className="absolute -top-1 -right-1 w-6 h-6 bg-green-300/40 rounded-full animate-ping delay-300"></div>
                  </div>
                </div>
              </div>
